...
2. Login and set subscription. Note az login isn't needed if your are using Azure Cloud Shell. Make sure context is set to the right subscription using the second command.
